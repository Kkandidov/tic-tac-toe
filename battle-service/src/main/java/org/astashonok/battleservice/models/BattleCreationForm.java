...
public class BattleCreationForm {
    ...
    @Min(value = BattleConstants.GAME_BOARD_HEIGHT_DEFAULT, message = ErrorMessagePattern.INCORRECT_GAME_BOARD_HEIGHT)
    private final int boardHeight;

    @Min(value = BattleConstants.GAME_BOARD_WIDTH_DEFAULT, message = ErrorMessagePattern.INCORRECT_GAME_BOARD_WIDTH)
